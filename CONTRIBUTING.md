# Contributing to OpenSergo

:balloon: Thanks for your help improving the project! We are so happy to have you!

There are opportunities to contribute to OpenSergo at any level. It doesn't matter if
...
<img src="https://github.com/volo-rs/opensergo/raw/main/.github/assets/volo-feishu-dev-group.png" alt="Volo dev group" width="50%" height="50%" />

_This guide is adapted from the [Tokio contributing guide](https://github.com/tokio-rs/tokio/blob/master/CONTRIBUTING.md)_.

## Conduct

See the [OpenSergo Code of Conduct](https://github.com/volo-rs/opensergo/blob/main/CODE_OF_CONDUCT.md).
...
1. By opening the issue for discussion: For instance, if you believe that you
   have discovered a bug in opensergo, creating a new issue in [the volo-rs/opensergo
...
3. By helping to resolve the issue: Typically this is done either in the form of
   ...
   OpenSergo in a concrete and reviewable manner.

[issue]: https://github.com/volo-rs/opensergo/issues
...
When opening a new issue in the OpenSergo issue tracker, you will be presented
...
cases should be limited, as much as possible, to using only OpenSergo APIs.
...
functional guidelines of the OpenSergo project.

## Pull Requests

Pull Requests are the way concrete changes are made to the code, documentation,
and dependencies in the OpenSergo repository.
...
example), it is either adding new functionality to OpenSergo or it is fixing
existing, broken functionality. In both of these cases, the pull request should
include one or more tests to ensure that OpenSergo does not regress in the future.
...
**Any OpenSergo community member is welcome to review any pull request**.

All OpenSergo contributors who choose to review and provide feedback on Pull
...
1. Does this change make sense for OpenSergo?
2. Does this change make OpenSergo better, even if only incrementally?
...
avoid stalling the Pull Request. Most nits can typically be fixed by the OpenSergo
...
a particular change that makes OpenSergo better, but the individual might just not
want to have anything to do with OpenSergo ever again. The goal is not just having
good code.
...
The OpenSergo GitHub repository has a lot of issues and PRs to keep track of. This
...
The area label describes the crates relevant to this issue or PR.
 ...
 - **A-opensergo** This issue concerns the `opensergo` crate.
 - **A-opensergo-proto** This issue concerns the `opensergo-proto` crate.
